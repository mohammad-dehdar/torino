...
function DropDownMenu({ mobile }) {
    ...
    return (
        <div className="w-[246px] absolute -left-10 top-10 mt-2 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5">
            <div className="py" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                ...
                <a href="#" className="flex items-center gap-2 px-4 py-3 text-sm hover:bg-gray-100" role="menuitem">
                ...
                <a href="#" className="flex items-center gap-2 px-4 py-3 text-sm text-rose-600 hover:bg-gray-100" role="menuitem">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
